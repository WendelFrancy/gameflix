  ...
  return (
    <>
      <StyledFooter>
        ...
        <Container>
          <TextFooter>
            Desenvolvido por Wendel Francy durante o <br />
            programa "ONE - Oracle Next Education".{" "}
          </TextFooter>

          <NavStyled>
            <NavItem to="https://www.linkedin.com/in/wendel-francy/" target="_blank">
              <IconLinkedin />
            </NavItem>
            <NavItem to="https://github.com/WendelFrancy" target="_blank">
              <IconGithub />
            </NavItem>
          </NavStyled>
        </Container>
